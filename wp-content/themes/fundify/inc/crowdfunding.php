...
function fundify_features_notice() {
	...
	<div class="updated">
		<p><?php printf( 
					__( '<strong>Notice:</strong> To take advantage of all of the great features Fundify offers, please install the <strong><a href="%s">IgnitionDeck Crowdfunding</a></strong>. <a href="%s" class="alignright">Hide this message.</a>', 'fundify' ), 
