...
function fundify_customize_register_hero( $wp_customize ) {
	if ( ! ( get_option( 'page_on_front' ) && ('page-templates/front-page.php' == get_page_template_slug( get_option( 'page_on_front' ) ) || 'page-templates/front-page-project.php' == get_page_template_slug( get_option( 'page_on_front' ) ) ) ) )
		return false;
