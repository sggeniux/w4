<div class="wrap">
	<div class="extension_header">
		<h1><?php _e('IgnitionDeck Modules', 'idf'); ?><button class="bulk_deactivate_modules button left" onclick="idf_flush_object('id_modules')"><?php _e('Flush Module Cache', 'idf'); ?></button></h1>
	</div>
	<?php
