		...
		<li class="md-box <?php echo $a_width; ?>">
			...
			<ul class="<?php echo $alayout; ?>">
				...
				<li class="expiring">
					...
					<span class="expirate_date"><?php _e('Your license will expire in', 'memberdeck'); ?> <?php echo (!empty($extension->days_left) ? $extension->days_left : ''); ?> days: <a href="<?php echo $prefix; ?>idc_renew=<?php echo $extension->occ_level; ?>" class="renew-link">Renew Now</a></span>
					<?php } ?>
				</li>
				<?php 
					}
