				...
				<tr><th scope="row"><?php _e( 'Destination', $this->_var ); ?></th>
					<td>
						...
						<?php $this->addRadio( $this->_var, 'destinationSelection', 'manual', __( 'Manual Path:', $this->_var ) ); ?>
							<input type="text" name="<?php echo $this->_var; ?>[destinationPath]" size="30" value="wp-content/uploads/default_avatars/<?php /*if ( isset( $_POST[$this->_var]['destinationPath'] ) ) echo $_POST[$this->_var]['destinationPath'];*/ ?>" /><br />
							<div style="margin-left:18px; width:400px;">
